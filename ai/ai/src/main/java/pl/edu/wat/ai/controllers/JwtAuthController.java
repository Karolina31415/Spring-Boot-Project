...
import pl.edu.wat.ai.dto.LoginUserDTO;
import pl.edu.wat.ai.jwt.JwtProvider;
import pl.edu.wat.ai.response.ResponseMessage;
import pl.edu.wat.ai.dto.NewUserDTO;
import pl.edu.wat.ai.response.JwtResponse;
...
public class JwtAuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody NewUserDTO newUserDTO) {
        ...
        User user = new User(newUserDTO.getUsername(), newUserDTO.getEmail(), encoder.encode(newUserDTO.getPassword()));
